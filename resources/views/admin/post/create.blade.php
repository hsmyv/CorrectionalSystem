                            ...
                            <form class="edit-profile m-b30">
                                <div class="row">
                                    <div class="col-12 m-t20">
                                        <div class="ml-auto">
                                            <h3 class="m-form__section">1. Publish Post</h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <div>
                                            <select name="category" class="form-control"
                                                ...
                                                <option value="video1.mp4">category 1</option>
                                                <option value="video2.mp4">category 2</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-3">
                                        <label for="photos" class="col-form-label">Image</label>
                                        <div>

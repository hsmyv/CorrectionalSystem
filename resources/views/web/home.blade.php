            ...
            <div class="with-sidebar-wrapper">
                                ...
                                <div id="slider_1" class="master-slider ms-skin-default">
                                    ...
                                    <div class="ms-slide" data-delay="7" data-fill-mode="fill">
                                        <img src="/plugins/masterslider/public/assets/css/blank.gif" alt=""
                                            title="" data-src="/upload/slider-1.jpg" />
                                        ...
                                        <div class="ms-layer  msp-cn-1-3" style=""
                                            ...
                                            data-delay="625" data-ease="easeOutQuint" data-offset-x="0"
                                        ...
                                        <div class="ms-layer  msp-cn-1-1" style=""
                                            ...
                                            data-ease="easeOutQuint" data-offset-x="0" data-offset-y="-100"
                                    ...
                                    <div class="ms-slide" data-delay="7" data-fill-mode="fill">
                                        <img src="/plugins/masterslider/public/assets/css/blank.gif" alt=""
                                            title="" data-src="/upload/slider-2.jpg" />
                                        ...
                                        <div class="ms-layer  msp-cn-1-5" style=""
                                            data-effect="t(true,150,n,n,n,n,n,n,n,n,n,n,n,n,n)" data-duration="350"
                                            data-ease="easeOutQuint" data-offset-x="0" data-offset-y="52"
                                            data-origin="ml" data-position="normal">
                                            Help Us</div>
                                        ...
                                        <div class="column-service-content-wrapper">
                                            ...
                                            <div class="column-service-content greennature-skin-content">
                                                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam.
                                                    Cras
                                                    mattis consectetur purus sit amet fermentum. Nulla vitae
                                                    elit
                                                    libero. Nullam quis risus eget urna mollis ornare vel eu
                                                    leo.
                                                </p>
                                            </div><a class="column-service-read-more" href="#">Learn
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <section id="content-section-3">
                    <div class="greennature-parallax-wrapper greennature-background-image gdlr-show-all no-skin"
                        ...
                        style="background-image: url('/upload/donation-bg.jpg'); padding-top: 90px; padding-bottom: 65px; ">
                        <div class="container">
                            <div class="six columns">
                                <div class="greennature-item greennature-action-ads-item"
                                    ...
                                    <div class="action-ads-caption greennature-skin-info">Your money can cure
                                        this
                                        earth</div>
                                    <div class="action-ads-divider" style="background: #facc2e;"></div>
                                    <div class="action-ads-content">
                                        <p>We are a larhge froup of people who powered movement fighting for a
                                            green
                                            and peaceful future for your land, forest, ocenas, foods, climate
                                            and
                                        ...
                                        <a class="action-ads-button large greennature-button greennature-lb-payment"
                                            href="#" style="color: #6d5b1c;background-color: #fec428;">Donate
                                            Now</a>
                                    </div>
                                </div>
                            </div>
                            <div class="six columns">
                                <div class="greennature-item greennature-action-ads-item"
                                    ...
                                    <h3 class="action-ads-title" style="color: #5dc269;">Stop Drilling, Need
                                        Action!</h3>
                                    <div class="action-ads-caption greennature-skin-info">Your voice does
                                        matter
                                    </div>
                                    <div class="action-ads-divider" style="background: #5dc269;"></div>
                                    <div class="action-ads-content">
                                        <p>The Obama administration just granted Shell&#8217;s final permit to
                                            drill
                                            in the Alaskan Arctic this summer despite overwhelming global public
                                            opposition and the obvious risks to Arctic communities, wildlife,
                                            and
                                            our climate. But this isn’t over. The President knows what’s at
                                            stake:
                                            his climate legacy.</p>
                                        <a class="action-ads-button large greennature-button"
                                            style="color: #ffffff;background-color: #5dc269;" href="#">Act
                                            Now!</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="greennature-item-title-container container">
                                    <div class="greennature-item-title-head">
                                        <h3
                                            ...
                                            <img src="/upload/icon-5.png" alt="" width="80"
                                                height="80" />Our Recent Projects
                                            ...
                                            <div
                                                ...
                                                <div class="greennature-ux greennature-classic-portfolio-ux">
                                                    ...
                                                    <div class="portfolio-classic-content">
                                                        <h3 class="portfolio-title"><a href="#">Wind
                                                                Energy</a></h3>
                                                        <div class="greennature-portfolio-info">
                                                            <div class="portfolio-info portfolio-tag"><span
                                                                    class="info-head greennature-title">Tags
                                                                </span><a href="#"
                                                                    rel="tag">Environment</a><span
                                                                    class="sep">,</span> <a href="#"
                                                                    rel="tag">Renewable Energy</a></div>
                                                            <div class="clear"></div>
                                                        </div>
                                                        <div class="portfolio-excerpt">Lorem ipsum dolor sit
                                                            amet,
                                            ...
                                            <div
                                                ...
                                                <div class="greennature-ux greennature-classic-portfolio-ux">
                                                    <div class="portfolio-thumbnail greennature-image"><img
                                                            ...
                                                            alt="" width="540" height="326" /><span
                                                            class="portfolio-overlay">&nbsp;</span><a
                                                            class="portfolio-overlay-icon" href="#"><span
                                                                class="portfolio-icon"><i
                                                                    class="fa fa-link"></i></span></a></div>
                                                    <div class="portfolio-classic-content">
                                                        ...
                                                        <div class="greennature-portfolio-info">
                                                            <div class="portfolio-info portfolio-tag"><span
                                                                    ...
                                                                    rel="tag">African</a><span
                                                                    class="sep">,</span> <a href="#"
                                                                    rel="tag">Animals</a></div>
                                                            <div class="clear"></div>
                                                        </div>
                                                        <div class="portfolio-excerpt">Lorem ipsum dolor sit
                                                            amet,
                                            ...
                                            <div
                                                ...
                                                <div class="greennature-ux greennature-classic-portfolio-ux">
                                                    <div class="portfolio-thumbnail greennature-image"><img
                                                            ...
                                                            class="portfolio-overlay">&nbsp;</span><a
                                                            class="portfolio-overlay-icon"
                                                            href="https://vimeo.com/101707505" data-rel="fancybox"
                                                            data-fancybox-type="iframe"><span
                                                                class="portfolio-icon"><i
                                                    ...
                                                    <div class="portfolio-classic-content">
                                                        ...
                                                        <div class="greennature-portfolio-info">
                                                            <div class="portfolio-info portfolio-tag"><span
                                                                    ...
                                                                    rel="tag">Cleaning</a><span
                                                                    class="sep">,</span> <a href="#"
                                                                    rel="tag">Volunteer</a></div>
                                                            <div class="clear"></div>
                                                        </div>
                                                        <div class="portfolio-excerpt">Lorem ipsum dolor sit
                                                            amet,
                ...
                <section id="content-section-5">
                    <div class="greennature-color-wrapper  gdlr-show-all greennature-skin-service-half greennature-half-bg-wrapper"
                        ...
                        <div class="greennature-half-bg greennature-bg-solid"
                            style="background-image: url(/upload/shutterstock_133689230.jpg);"></div>
                        <div class="container">
                            <div class="six columns">
                                ...
                                <div class="greennature-item greennature-icon-with-list-item">
                                    <div class="list-with-icon-ux greennature-ux">
                                        <div class="list-with-icon greennature-left">
                                            <div class="list-with-icon-image"><img src="/upload/icon-1.png"
                                                    alt="" width="80" height="80" /></div>
                                    ...
                                    <div class="list-with-icon-ux greennature-ux">
                                        <div class="list-with-icon greennature-left">
                                            <div class="list-with-icon-image"><img src="/upload/icon-2.png"
                                                    alt="" width="80" height="80" /></div>
                                            <div class="list-with-icon-content">
                                                <div class="list-with-icon-title greennature-skin-title">
                                                    Ullamcorper Mattis Etiam</div>
                                                <div class="list-with-icon-caption">
                                                    <p>Integer posuere erat a ante venenatis dapibus posuere
                                                        velit
                                                        aliquet. Sed posuere consectetur est at lobortis. Nullam
                                    ...
                                    <div class="list-with-icon-ux greennature-ux">
                                        <div class="list-with-icon greennature-left">
                                            <div class="list-with-icon-image"><img src="/upload/icon-3.png"
                                                    alt="" width="80" height="80" /></div>
                                            <div class="list-with-icon-content">
                        ...
                        <div class="container">
                                ...
                                <div
                                    ...
                                    <div class="greennature-item-title-container container">
                                        <div class="greennature-item-title-head">
                                            <h3
                                                class="greennature-item-title greennature-skin-title greennature-skin-border">
                                                Recent News</h3><a class="greennature-item-title-link"
                                                href="#">Read All News</a>
                                            <div class="clear"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="four columns">
                                ...
                                <div class="greennature-item greennature-content-item">
                                    <p><strong><a style="font-size: 15px;" href="#">Learn more about
                                                this
                                                campaign</a></strong></p>
                                </div>
                            </div>
                                                        ...
                                                        <div class="testimonial-content-wrapper">
                                                            <div class="testimonial-content greennature-skin-content">
                                                                <p>Morbi leo risus, porta ac consectetur ac,
                                                                    vestibulum at eros. Etiam porta sem
                                                                    malesuada
                                    ...
                                    <div class="newsletter newsletter-subscription">
                                        <form method="post" action="#" onsubmit="return newsletter_check(this)">
                                            <input class="newsletter-email" type="email" name="ne"
                                                size="30" required placeholder="Please fill your email" />
                                ...
                                <div class="greennature-twitter-item-wrapper"><i class="fa fa-twitter"></i>
                                            ...
                                            <ul class="slides">
                                                <li>
                                                    <div class="greennature-twitter"><span
                                                            ...
                                                            href="#theme/statuses/1100397143569850368"
                                                ...
                                                <li>
                                                    <div class="greennature-twitter"><span
                                                            ...
                                                            Today got many complaints about error on Ticksy
                                                            site.
                                                ...
                                                <li>
                                                    <div class="greennature-twitter"><span
                                                            ...
                                                            Sorry for the issue, after updating, go to admin
                                                            panel
                                                            and click save changes once. All will be back
                                                            :)</span><a class="greennature-twitter-time"
                                                            href="#theme/statuses/1083252477397393409"
                                                ...
                                                <li>
                                                    <div class="greennature-twitter"><span
                                                            ...
                                                            Newsstand Theme. See this list here :â¦ <a target="_blank"
                                    ...
                                    <div
                                        ...
                                        <i class="icon-angle-left greennature-flex-prev"></i><i
                                            class="icon-angle-right greennature-flex-next"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="one-fifth column"></div>
                        ...
                        <div class="container">
                            <div class="three columns">
                                <div class="greennature-skill-item-wrapper greennature-skin-content greennature-item greennature-style-2"
                                    style="margin-bottom: 70px;"><img src="/upload/icon-4.png" alt=""
                                        width="80" height="80" />
                                    <div class="greennature-skill-item-title" style="color: #5dc269;">
                                        1,000,000
                                    </div>
                            ...
                            <div class="three columns">
                                <div class="greennature-skill-item-wrapper greennature-skin-content greennature-item greennature-style-2"
                                    style="margin-bottom: 70px;"><img src="/upload/icon-5.png" alt=""
                                        width="80" height="80" />
                                    <div class="greennature-skill-item-title" style="color: #5dc269;">700
                                    </div>
                                    <div class="greennature-skill-item-caption" style="color: #ffffff;">
                                        Scientists</div>
                                </div>
                            </div>
                            <div class="three columns">
                                <div class="greennature-skill-item-wrapper greennature-skin-content greennature-item greennature-style-2"
                                    style="margin-bottom: 70px;"><img src="/upload/icon-1.png" alt=""
                                        width="80" height="80" />
                                    <div class="greennature-skill-item-title" style="color: #5dc269;">99.99%
                                    </div>
                                    <div class="greennature-skill-item-caption" style="color: #ffffff;">
                                        Recycling</div>
                                </div>
                            ...
                            <div class="three columns">
                                <div class="greennature-skill-item-wrapper greennature-skin-content greennature-item greennature-style-2"
                                    style="margin-bottom: 70px;"><img src="/upload/icon-2.png" alt=""
                                        width="80" height="80" />
                                    <div class="greennature-skill-item-title" style="color: #5dc269;">2000MW
                                    </div>
                                    <div class="greennature-skill-item-caption" style="color: #ffffff;">
                                        Solar
                                        Power</div>
                            ...
                            <div class="greennature-stunning-item-ux greennature-ux">
                                <div class="greennature-item greennature-stunning-item greennature-stunning-center">
                                    <h2 class="stunning-item-title">The only way to make this happened is to
                                        take
                                        action!</h2>
